 ...
 export default class Circle extends Polygon {
     ...
     constructor(viewer, geoFeature) {
         ...
         this.properties.plotType = PlotTypes.CIRCLE; //标绘类型
         this.properties.plotName = "正圆"; //标绘名称 
     ...
     generate() {
         ...
         var center = this.coordinates[0][0];
         var radius = this.distance(center, this.coordinates[0][1]);
