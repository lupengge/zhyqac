...
export default class MilitaryPlotEditor {
    ...
    initMouseMoveEventHandler() {
        this.eventHandler.setInputAction(((e) => {
            ...
            if (this.editVertext.type == "MilitaryPlotEditMoveVertex") {
                ...
                //如果是点 需要更新高度
                if (this.militaryPlot.properties.plotType == PlotTypes.MARKER) {
                    this.militaryPlot.setHeight(this.getPositionHeight(this.editPositions[0]));
                }
    ...
    createEditVertex() {
        ...
        //对圆进行特殊处理
        if (this.militaryPlot.properties.plotName == PlotTypes.CIRCLE) {
